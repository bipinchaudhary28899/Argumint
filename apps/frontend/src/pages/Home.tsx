    ...
    <div className="bg-grid" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "var(--bg)" }}>
      ...
      <nav className="game-nav">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: isMobile ? "0.5rem" : "1rem" }}>
          ...
          <button onClick={handleLogout} disabled={isLoading} className="btn-danger"
      ...
      <main style={{ position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: isMobile ? "2rem 1.25rem" : "1.5rem 1rem" }}>
        {/* Hero */}
        <div className="fade-up" style={{ textAlign: "center", maxWidth: 640, marginBottom: "2.5rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(2rem, 8vw, 4.5rem)", fontWeight: 900, lineHeight: 1.05, letterSpacing: "-0.03em", margin: "0 0 1.25rem", color: "var(--text)" }}>
            Argue smarter.<br />
          ...
          <p style={{ color: "var(--muted)", fontSize: isMobile ? "0.95rem" : "1.1rem", lineHeight: 1.6, maxWidth: 480, margin: "0 auto" }}>
